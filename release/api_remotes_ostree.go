...
*/
func (a *RemotesOstreeAPIService) RemotesOstreeOstreeCreate(ctx context.Context, pulpDomain string) RemotesOstreeAPIRemotesOstreeOstreeCreateRequest {
	return RemotesOstreeAPIRemotesOstreeOstreeCreateRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *RemotesOstreeAPIService) RemotesOstreeOstreeCreateExecute(r RemotesOstreeAPIRemotesOstreeOstreeCreateRequest) (*OstreeOstreeRemoteResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/pulp/{pulp_domain}/api/v3/remotes/ostree/ostree/"
...
*/
func (a *RemotesOstreeAPIService) RemotesOstreeOstreeList(ctx context.Context, pulpDomain string) RemotesOstreeAPIRemotesOstreeOstreeListRequest {
	return RemotesOstreeAPIRemotesOstreeOstreeListRequest{
		ApiService: a,
		ctx: ctx,
		pulpDomain: pulpDomain,
