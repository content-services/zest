...
// checks if the MavenMavenMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MavenMavenMetadata{}

// MavenMavenMetadata A Serializer for MavenMetadata.
type MavenMavenMetadata struct {
...
type _MavenMavenMetadata MavenMavenMetadata
...
func (o MavenMavenMetadata) MarshalJSON() ([]byte, error) {
...
func (o MavenMavenMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MavenMavenMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varMavenMavenMetadata := _MavenMavenMetadata{}

	err = json.Unmarshal(data, &varMavenMavenMetadata)

	if err != nil {
		return err
	}

	*o = MavenMavenMetadata(varMavenMavenMetadata)
...
type NullableMavenMavenMetadata struct {
	value *MavenMavenMetadata
	isSet bool
}

func (v NullableMavenMavenMetadata) Get() *MavenMavenMetadata {
	return v.value
}

func (v *NullableMavenMavenMetadata) Set(val *MavenMavenMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMavenMavenMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMavenMavenMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMavenMavenMetadata(val *MavenMavenMetadata) *NullableMavenMavenMetadata {
	return &NullableMavenMavenMetadata{value: val, isSet: true}
}

func (v NullableMavenMavenMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMavenMavenMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
