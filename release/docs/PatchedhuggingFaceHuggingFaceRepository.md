...
`func (o *PatchedhuggingFaceHuggingFaceRepository) GetRetainCheckpoints() int64`

GetRetainCheckpoints returns the RetainCheckpoints field if non-nil, zero value otherwise.

### GetRetainCheckpointsOk

`func (o *PatchedhuggingFaceHuggingFaceRepository) GetRetainCheckpointsOk() (*int64, bool)`
...
`func (o *PatchedhuggingFaceHuggingFaceRepository) SetRetainCheckpoints(v int64)`

SetRetainCheckpoints sets RetainCheckpoints field to given value.

### HasRetainCheckpoints

`func (o *PatchedhuggingFaceHuggingFaceRepository) HasRetainCheckpoints() bool`

HasRetainCheckpoints returns a boolean if a field has been set.

### SetRetainCheckpointsNil

`func (o *PatchedhuggingFaceHuggingFaceRepository) SetRetainCheckpointsNil(b bool)`

 SetRetainCheckpointsNil sets the value for RetainCheckpoints to be an explicit nil

### UnsetRetainCheckpoints
`func (o *PatchedhuggingFaceHuggingFaceRepository) UnsetRetainCheckpoints()`
