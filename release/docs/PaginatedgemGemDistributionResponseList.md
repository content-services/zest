...
**Results** | [**[]GemGemDistributionResponse**](GemGemDistributionResponse.md) |  | 

## Methods

### NewPaginatedgemGemDistributionResponseList

`func NewPaginatedgemGemDistributionResponseList(count int32, results []GemGemDistributionResponse, ) *PaginatedgemGemDistributionResponseList`
