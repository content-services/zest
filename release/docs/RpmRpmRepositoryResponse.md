...
`func (o *RpmRpmRepositoryResponse) SetRetainCheckpointsNil(b bool)`
...
`func (o *RpmRpmRepositoryResponse) SetOsvConfigNil(b bool)`

 SetOsvConfigNil sets the value for OsvConfig to be an explicit nil

### UnsetOsvConfig
`func (o *RpmRpmRepositoryResponse) UnsetOsvConfig()`
