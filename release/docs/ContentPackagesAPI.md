...
> SetLabelResponse ContentRpmPackagesSetLabel(ctx, rpmPackageHref).SetLabel(setLabel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentPackagesAPI.ContentRpmPackagesSetLabel(context.Background(), rpmPackageHref).SetLabel(setLabel).Execute()
	if err != nil {
...
> UnsetLabelResponse ContentRpmPackagesUnsetLabel(ctx, rpmPackageHref).UnsetLabel(unsetLabel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentPackagesAPI.ContentRpmPackagesUnsetLabel(context.Background(), rpmPackageHref).UnsetLabel(unsetLabel).Execute()
	if err != nil {
