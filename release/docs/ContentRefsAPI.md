...
> SetLabelResponse ContentOstreeRefsSetLabel(ctx, ostreeOstreeRefHref).SetLabel(setLabel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentRefsAPI.ContentOstreeRefsSetLabel(context.Background(), ostreeOstreeRefHref).SetLabel(setLabel).Execute()
	if err != nil {
...
> UnsetLabelResponse ContentOstreeRefsUnsetLabel(ctx, ostreeOstreeRefHref).UnsetLabel(unsetLabel).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentRefsAPI.ContentOstreeRefsUnsetLabel(context.Background(), ostreeOstreeRefHref).UnsetLabel(unsetLabel).Execute()
	if err != nil {
