...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `python.python` - python.python* `rpm.rpm` - rpm.rpm* `file.file` - file.file* `npm.npm` - npm.npm* `gem.gem` - gem.gem* `container.pull-through` - container.pull-through* `container.container` - container.container* `ostree.ostree` - ostree.ostree* `maven.maven` - maven.maven (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `python.python` - python.python* `rpm.rpm` - rpm.rpm* `file.file` - file.file* `npm.npm` - npm.npm* `gem.gem` - gem.gem* `container.pull-through` - container.pull-through* `container.container` - container.container* `ostree.ostree` - ostree.ostree* `maven.maven` - maven.maven (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;python.python&#x60; - python.python* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file* &#x60;npm.npm&#x60; - npm.npm* &#x60;gem.gem&#x60; - gem.gem* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;maven.maven&#x60; - maven.maven | 
