...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `ostree.ostree` - ostree.ostree* `npm.npm` - npm.npm* `container.pull-through` - container.pull-through* `container.container` - container.container* `maven.maven` - maven.maven* `python.python` - python.python* `gem.gem` - gem.gem* `rpm.rpm` - rpm.rpm* `file.file` - file.file (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `ostree.ostree` - ostree.ostree* `npm.npm` - npm.npm* `container.pull-through` - container.pull-through* `container.container` - container.container* `maven.maven` - maven.maven* `python.python` - python.python* `gem.gem` - gem.gem* `rpm.rpm` - rpm.rpm* `file.file` - file.file (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;npm.npm&#x60; - npm.npm* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;maven.maven&#x60; - maven.maven* &#x60;python.python&#x60; - python.python* &#x60;gem.gem&#x60; - gem.gem* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;npm.npm&#x60; - npm.npm* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;maven.maven&#x60; - maven.maven* &#x60;python.python&#x60; - python.python* &#x60;gem.gem&#x60; - gem.gem* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file | 
