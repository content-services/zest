...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `rpm.rpm` - rpm.rpm* `maven.maven` - maven.maven* `file.file` - file.file* `python.python` - python.python* `npm.npm` - npm.npm* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `container.pull-through` - container.pull-through* `container.container` - container.container (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `rpm.rpm` - rpm.rpm* `maven.maven` - maven.maven* `file.file` - file.file* `python.python` - python.python* `npm.npm` - npm.npm* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `container.pull-through` - container.pull-through* `container.container` - container.container (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;maven.maven&#x60; - maven.maven* &#x60;file.file&#x60; - file.file* &#x60;python.python&#x60; - python.python* &#x60;npm.npm&#x60; - npm.npm* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;gem.gem&#x60; - gem.gem* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container | 
