...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `python.python` - python.python* `npm.npm` - npm.npm* `container.pull-through` - container.pull-through* `container.container` - container.container* `file.file` - file.file* `maven.maven` - maven.maven* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `rpm.rpm` - rpm.rpm (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `python.python` - python.python* `npm.npm` - npm.npm* `container.pull-through` - container.pull-through* `container.container` - container.container* `file.file` - file.file* `maven.maven` - maven.maven* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `rpm.rpm` - rpm.rpm (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;python.python&#x60; - python.python* &#x60;npm.npm&#x60; - npm.npm* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;file.file&#x60; - file.file* &#x60;maven.maven&#x60; - maven.maven* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;gem.gem&#x60; - gem.gem* &#x60;rpm.rpm&#x60; - rpm.rpm | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;python.python&#x60; - python.python* &#x60;npm.npm&#x60; - npm.npm* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;file.file&#x60; - file.file* &#x60;maven.maven&#x60; - maven.maven* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;gem.gem&#x60; - gem.gem* &#x60;rpm.rpm&#x60; - rpm.rpm | 
