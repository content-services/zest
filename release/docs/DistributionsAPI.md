...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.artifact` - core.artifact* `core.openpgp` - core.openpgp* `npm.npm` - npm.npm* `maven.maven` - maven.maven* `hugging_face.hugging-face` - hugging_face.hugging-face* `container.pull-through` - container.pull-through* `container.container` - container.container* `rpm.rpm` - rpm.rpm* `file.file` - file.file* `python.python` - python.python (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;npm.npm&#x60; - npm.npm* &#x60;maven.maven&#x60; - maven.maven* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file* &#x60;python.python&#x60; - python.python | 
