...
`func (o *RpmRpmRepository) SetPackageSigningFingerprintNil(b bool)`
...
`func (o *RpmRpmRepository) UnsetPackageSigningFingerprint()`
...
`func (o *RpmRpmRepository) GetOsvConfig() []PatchedrpmRpmRepositoryOsvConfigInner`

GetOsvConfig returns the OsvConfig field if non-nil, zero value otherwise.

### GetOsvConfigOk

`func (o *RpmRpmRepository) GetOsvConfigOk() (*[]PatchedrpmRpmRepositoryOsvConfigInner, bool)`
...
`func (o *RpmRpmRepository) SetOsvConfig(v []PatchedrpmRpmRepositoryOsvConfigInner)`

SetOsvConfig sets OsvConfig field to given value.

### HasOsvConfig

`func (o *RpmRpmRepository) HasOsvConfig() bool`

HasOsvConfig returns a boolean if a field has been set.

### SetOsvConfigNil

`func (o *RpmRpmRepository) SetOsvConfigNil(b bool)`

 SetOsvConfigNil sets the value for OsvConfig to be an explicit nil

### UnsetOsvConfig
`func (o *RpmRpmRepository) UnsetOsvConfig()`
