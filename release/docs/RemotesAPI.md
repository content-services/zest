...
func main() {
    ...
    pulpType := "pulpType_example" // string | Pulp type  * `rpm.rpm` - rpm.rpm * `rpm.uln` - rpm.uln (optional)
    pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.  * `rpm.rpm` - rpm.rpm * `rpm.uln` - rpm.uln (optional)
 ...
 **pulpType** | **string** | Pulp type  * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;rpm.uln&#x60; - rpm.uln | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.  * &#x60;rpm.rpm&#x60; - rpm.rpm * &#x60;rpm.uln&#x60; - rpm.uln | 
 **q** | **string** |  | 
