...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `npm.npm` - npm.npm* `hugging_face.hugging-face` - hugging_face.hugging-face* `python.python` - python.python* `maven.maven` - maven.maven* `container.container` - container.container* `container.pull-through` - container.pull-through* `file.file` - file.file* `file.git` - file.git* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln (optional)
