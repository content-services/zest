...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `container.container` - container.container* `container.pull-through` - container.pull-through* `ostree.ostree` - ostree.ostree* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln* `maven.maven` - maven.maven* `gem.gem` - gem.gem* `npm.npm` - npm.npm* `file.file` - file.file* `python.python` - python.python (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `container.container` - container.container* `container.pull-through` - container.pull-through* `ostree.ostree` - ostree.ostree* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln* `maven.maven` - maven.maven* `gem.gem` - gem.gem* `npm.npm` - npm.npm* `file.file` - file.file* `python.python` - python.python (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;container.container&#x60; - container.container* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;rpm.uln&#x60; - rpm.uln* &#x60;maven.maven&#x60; - maven.maven* &#x60;gem.gem&#x60; - gem.gem* &#x60;npm.npm&#x60; - npm.npm* &#x60;file.file&#x60; - file.file* &#x60;python.python&#x60; - python.python | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;container.container&#x60; - container.container* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;rpm.uln&#x60; - rpm.uln* &#x60;maven.maven&#x60; - maven.maven* &#x60;gem.gem&#x60; - gem.gem* &#x60;npm.npm&#x60; - npm.npm* &#x60;file.file&#x60; - file.file* &#x60;python.python&#x60; - python.python | 
