...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `python.python` - python.python* `container.container` - container.container* `container.pull-through` - container.pull-through* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln* `file.file` - file.file* `maven.maven` - maven.maven* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `npm.npm` - npm.npm (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `python.python` - python.python* `container.container` - container.container* `container.pull-through` - container.pull-through* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln* `file.file` - file.file* `maven.maven` - maven.maven* `ostree.ostree` - ostree.ostree* `gem.gem` - gem.gem* `npm.npm` - npm.npm (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;python.python&#x60; - python.python* &#x60;container.container&#x60; - container.container* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;rpm.uln&#x60; - rpm.uln* &#x60;file.file&#x60; - file.file* &#x60;maven.maven&#x60; - maven.maven* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;gem.gem&#x60; - gem.gem* &#x60;npm.npm&#x60; - npm.npm | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;python.python&#x60; - python.python* &#x60;container.container&#x60; - container.container* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;rpm.uln&#x60; - rpm.uln* &#x60;file.file&#x60; - file.file* &#x60;maven.maven&#x60; - maven.maven* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;gem.gem&#x60; - gem.gem* &#x60;npm.npm&#x60; - npm.npm | 
