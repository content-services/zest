...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `npm.npm` - npm.npm* `maven.maven` - maven.maven* `python.python` - python.python* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `file.git` - file.git* `container.container` - container.container* `container.pull-through` - container.pull-through* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `npm.npm` - npm.npm* `maven.maven` - maven.maven* `python.python` - python.python* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `file.git` - file.git* `container.container` - container.container* `container.pull-through` - container.pull-through* `rpm.rpm` - rpm.rpm* `rpm.uln` - rpm.uln (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;npm.npm&#x60; - npm.npm* &#x60;maven.maven&#x60; - maven.maven* &#x60;python.python&#x60; - python.python* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;file.file&#x60; - file.file* &#x60;file.git&#x60; - file.git* &#x60;container.container&#x60; - container.container* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;rpm.uln&#x60; - rpm.uln | 
