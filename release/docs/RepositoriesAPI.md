...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `gem.gem` - gem.gem* `file.file` - file.file* `ostree.ostree` - ostree.ostree* `rpm.rpm` - rpm.rpm* `python.python` - python.python (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `gem.gem` - gem.gem* `file.file` - file.file* `ostree.ostree` - ostree.ostree* `rpm.rpm` - rpm.rpm* `python.python` - python.python (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;gem.gem&#x60; - gem.gem* &#x60;file.file&#x60; - file.file* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;python.python&#x60; - python.python | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;gem.gem&#x60; - gem.gem* &#x60;file.file&#x60; - file.file* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;python.python&#x60; - python.python | 
