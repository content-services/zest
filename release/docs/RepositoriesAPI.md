...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `core.openpgp` - core.openpgp* `python.python` - python.python* `file.file` - file.file* `rpm.rpm` - rpm.rpm* `npm.npm` - npm.npm* `gem.gem` - gem.gem* `container.container` - container.container* `container.container-push` - container.container-push* `ostree.ostree` - ostree.ostree* `maven.maven` - maven.maven (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `core.openpgp` - core.openpgp* `python.python` - python.python* `file.file` - file.file* `rpm.rpm` - rpm.rpm* `npm.npm` - npm.npm* `gem.gem` - gem.gem* `container.container` - container.container* `container.container-push` - container.container-push* `ostree.ostree` - ostree.ostree* `maven.maven` - maven.maven (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;python.python&#x60; - python.python* &#x60;file.file&#x60; - file.file* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;npm.npm&#x60; - npm.npm* &#x60;gem.gem&#x60; - gem.gem* &#x60;container.container&#x60; - container.container* &#x60;container.container-push&#x60; - container.container-push* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;maven.maven&#x60; - maven.maven | 
