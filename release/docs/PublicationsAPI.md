...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `python.python` - python.python* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `rpm.rpm` - rpm.rpm (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `python.python` - python.python* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `rpm.rpm` - rpm.rpm (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;python.python&#x60; - python.python* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;file.file&#x60; - file.file* &#x60;rpm.rpm&#x60; - rpm.rpm | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;python.python&#x60; - python.python* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;file.file&#x60; - file.file* &#x60;rpm.rpm&#x60; - rpm.rpm | 
