...
func main() {
	...
	pulpType := "pulpType_example" // string | Pulp type* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `rpm.rpm` - rpm.rpm* `python.python` - python.python (optional)
	pulpTypeIn := []string{"PulpTypeIn_example"} // []string | Multiple values may be separated by commas.* `hugging_face.hugging-face` - hugging_face.hugging-face* `file.file` - file.file* `rpm.rpm` - rpm.rpm* `python.python` - python.python (optional)
 ...
 **pulpType** | **string** | Pulp type* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;file.file&#x60; - file.file* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;python.python&#x60; - python.python | 
 **pulpTypeIn** | **[]string** | Multiple values may be separated by commas.* &#x60;hugging_face.hugging-face&#x60; - hugging_face.hugging-face* &#x60;file.file&#x60; - file.file* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;python.python&#x60; - python.python | 
