...
type PaginatedHeaderContentGuardResponseList struct {
	...
	Results []HeaderContentGuardResponse `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []HeaderContentGuardResponse and assigns it to the Results field.
