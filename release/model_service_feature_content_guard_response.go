...
func (o *ServiceFeatureContentGuardResponse) SetDescriptionNil() {
...
func (o *ServiceFeatureContentGuardResponse) SetJqFilterNil() {
	o.JqFilter.Set(nil)
}
...
func (o *ServiceFeatureContentGuardResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varServiceFeatureContentGuardResponse)
