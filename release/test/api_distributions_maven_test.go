...
func Test_zest_DistributionsMavenAPIService(t *testing.T) {
	...
	t.Run("Test DistributionsMavenAPIService DistributionsMavenMavenCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DistributionsMavenAPI.DistributionsMavenMavenCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test DistributionsMavenAPIService DistributionsMavenMavenList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DistributionsMavenAPI.DistributionsMavenMavenList(context.Background(), pulpDomain).Execute()
