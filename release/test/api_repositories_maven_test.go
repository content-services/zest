...
func Test_zest_RepositoriesMavenAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesMavenAPIService RepositoriesMavenMavenCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesMavenAPI.RepositoriesMavenMavenCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test RepositoriesMavenAPIService RepositoriesMavenMavenList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesMavenAPI.RepositoriesMavenMavenList(context.Background(), pulpDomain).Execute()
