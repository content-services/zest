...
func Test_zest_RepositoriesPythonAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonList(context.Background(), pulpDomain).Execute()
