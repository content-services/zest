...
func Test_zest_RepositoriesRpmVersionsAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesRpmVersionsAPIService RepositoriesRpmRpmVersionsScan", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var rpmRpmRepositoryVersionHref string

		resp, httpRes, err := apiClient.RepositoriesRpmVersionsAPI.RepositoriesRpmRpmVersionsScan(context.Background(), rpmRpmRepositoryVersionHref).Execute()
