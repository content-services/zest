...
func Test_zest_AcsFileAPIService(t *testing.T) {
	...
	t.Run("Test AcsFileAPIService AcsFileFileCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.AcsFileAPI.AcsFileFileCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test AcsFileAPIService AcsFileFileList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.AcsFileAPI.AcsFileFileList(context.Background(), pulpDomain).Execute()
