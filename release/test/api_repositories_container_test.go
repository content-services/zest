...
func Test_zest_RepositoriesContainerAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesContainerAPIService RepositoriesContainerContainerCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesContainerAPI.RepositoriesContainerContainerCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test RepositoriesContainerAPIService RepositoriesContainerContainerList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesContainerAPI.RepositoriesContainerContainerList(context.Background(), pulpDomain).Execute()
