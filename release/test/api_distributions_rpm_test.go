...
func Test_zest_DistributionsRpmAPIService(t *testing.T) {
	...
	t.Run("Test DistributionsRpmAPIService DistributionsRpmRpmCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DistributionsRpmAPI.DistributionsRpmRpmCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test DistributionsRpmAPIService DistributionsRpmRpmList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DistributionsRpmAPI.DistributionsRpmRpmList(context.Background(), pulpDomain).Execute()
