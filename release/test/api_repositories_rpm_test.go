...
func Test_zest_RepositoriesRpmAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesRpmAPIService RepositoriesRpmRpmCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesRpmAPI.RepositoriesRpmRpmCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test RepositoriesRpmAPIService RepositoriesRpmRpmList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesRpmAPI.RepositoriesRpmRpmList(context.Background(), pulpDomain).Execute()
