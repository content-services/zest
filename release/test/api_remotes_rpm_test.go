...
func Test_zest_RemotesRpmAPIService(t *testing.T) {
	...
	t.Run("Test RemotesRpmAPIService RemotesRpmRpmCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RemotesRpmAPI.RemotesRpmRpmCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test RemotesRpmAPIService RemotesRpmRpmList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RemotesRpmAPI.RemotesRpmRpmList(context.Background(), pulpDomain).Execute()
