...
func Test_zest_PublicationsFileAPIService(t *testing.T) {
	...
	t.Run("Test PublicationsFileAPIService PublicationsFileFileCreate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PublicationsFileAPI.PublicationsFileFileCreate(context.Background(), pulpDomain).Execute()
	...
	t.Run("Test PublicationsFileAPIService PublicationsFileFileList", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PublicationsFileAPI.PublicationsFileFileList(context.Background(), pulpDomain).Execute()
